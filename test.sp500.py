...
test_start = datetime(2003, 9, 22, 8, 0, 0)
test_end = datetime(2018, 2, 28, 23, 0 , 0)
test_env = trading_env.get_env('data/sp500.csv', test_start, test_end, 10000, 0.01, render_mode="plain_text_info")
